...
// BEGIN CUT HERE
    printf("countA:%d countB:%d, maxA:%d maxB:%d, adiv:%d-%d => %d, bdiv:%d-%d => %d, a=%d,b=%d\n",
           countA,countB, maxA,maxB, adivmin,adivmax,adiv, bdivmin,bdivmax,bdiv, a,b);
// END CUT HERE
    return a+b;
  }
};
