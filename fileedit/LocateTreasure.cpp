...
// END CUT HERE
	...
	long long Kq = K / 12, Kr = K % 12;
	int m_ = dig(multi);
// BEGIN CUT HERE
	// printf("K=%d, Kq=%lld, Kr=%lld; m=%d\n", K, Kq, Kr, m_);
	//long long Kq = K / 12, Kr = K % 12;
	/*	
...
// END CUT HERE
	...
	if (Kq > 0) {
	  x = (m_ + t[5][m_] + t[9][m_]) + (Kq-1)*(t[13][m_] + t[5][m_] + t[9][m_])
		- Kq * (t[3][m_] + t[7][m_] + t[11][m_]);
	  y = (1 + t[4][m_] + t[8][m_]) + (Kq-1)*(t[12][m_] + t[4][m_] + t[8][m_])
	...
	int g = (Kq == 0) ? 1 : t[12][m_];
	for (int i=0; i<Kr; i++) {
	  int d = dig(g);
// BEGIN CUT HERE
/*
	  printf("K=%d (4*%lld+%lld), i=%d, d=%d, x+=%d*%d=%d, y+=%d*%d=%d\n",
			 K, Kq, Kr, i,
			 d, 
...
public:
  void run_test(int Case) {
	...
	if ((Case == -1) || (Case == 48)) test_case_48();
	/**
	if ((Case == -1) || (Case == 7)) test_case_7();
...
private:
  ...
  void test_case_0() { int Arg0 = 5; int Arg1 = 2; string Arg2 = "-6 4";
	verify_case(0, Arg2, location(Arg0, Arg1)); }
  void test_case_1() { int Arg0 = 99; int Arg1 = 1; string Arg2 = "1 0";
	verify_case(1, Arg2, location(Arg0, Arg1)); }
  void test_case_2() { int Arg0 = 5226; int Arg1 = 4; string Arg2 = "10 -2";
	verify_case(2, Arg2, location(Arg0, Arg1)); }
  void test_case_3() { int Arg0 = 6; int Arg1 = 9; string Arg2 = "9 1";
	verify_case(3, Arg2, location(Arg0, Arg1)); }
  void test_case_4() { int Arg0 = 1000000000; int Arg1 = 2; string Arg2 = "-6 -3";
	verify_case(4, Arg2, location(Arg0, Arg1)); }
  void test_case_5() { int Arg0 = 79025992; int Arg1 = 1; string Arg2 = "0 0";
	verify_case(5, Arg2, location(Arg0, Arg1)); }
  void test_case_6() { int Arg0 = 219683641; int Arg1 = 3; string Arg2 = "-6 1"; //
	verify_case(6, Arg2, location(Arg0, Arg1)); }
  void test_case_7() { int Arg0 = 247731190; int Arg1 = 4; string Arg2 = "7 4";
	verify_case(7, Arg2, location(Arg0, Arg1)); }
  void test_case_10() { int Arg0 = 260501341; int Arg1 = 7; string Arg2 = "0 1";
	verify_case(10, Arg2, location(Arg0, Arg1)); }
  void test_case_48() { int Arg0 = 217085866; int Arg1 = 180; string Arg2 = "9 1";
	verify_case(48, Arg2, location(Arg0, Arg1)); }
  /**
